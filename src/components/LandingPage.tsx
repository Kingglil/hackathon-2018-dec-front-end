        ...
        return (
            <div id="landing-page">
                <div id="landing-page-navbar">
                    <button onClick={() => this.onClick(2)} className="pure-button pure-button-primary navbar-item">Register</button>
                ...
                <div id="landing-page-content">
                    <div id="landing-page-left">
                        <div id="landing-page-left-content">
                            ...
                            <button onClick={() => this.onClick(2)} className="pure-button pure-button-primary landing-page-button">Register</button>
                            <img src={logo} />
                        </div>
                    </div>
